...
def env_vs_cs2(year, month):
    ...
    save_name = f"/Users/theajonsson/Desktop/{year}_{month}.png"
...
if False:
    folder = "/Users/theajonsson/Desktop/Envisat_vs_CS2"

    months_1011 = ["2010_11.png", "2010_12.png", "2011_01.png", "2011_02.png", "2011_03.png", "2011_04.png"]
    images_1011 = [Image.open(os.path.join(folder, f)) for f in months_1011]

    fig1, axs1 = plt.subplots(nrows=2, ncols=3, figsize=(8.27, 11.69))
    ...
    fig1.savefig("/Users/theajonsson/Desktop/2010_2011_plot.png", dpi=300, bbox_inches="tight")
    plt.show()



    months_1112 = ["2011_10.png", "2011_11.png", "2011_12.png", "2012_01.png", "2012_02.png", "2012_03.png"]
    images_1112 = [Image.open(os.path.join(folder, f)) for f in months_1112]

    fig2, axs2 = plt.subplots(nrows=2, ncols=3, figsize=(8.27, 11.69))
    ...
    fig2.savefig("/Users/theajonsson/Desktop/2011_2012_plot.png", dpi=300, bbox_inches="tight")
    plt.show()
