...
Purpose:    Create individual plots of EnvSat SITs against CS-2 SITs
            Debug: Plot all saved indivudal plots as two plots (2010/2011 and 2011/2012)

Input:      year, month (string)
Return:     N/A
"""
def env_vs_cs2(year, month, debug=False):
...
# Make the plots of Envisat SIT vs CryoSat-2 SIT
for year, months in data.items():
    for month in months:
        env_vs_cs2(year, month, debug=True)     # Debug: Plots (2010/2011 and 2011/2012)
